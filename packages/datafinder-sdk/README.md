...
| `analysis.query` | Run an event analysis DSL query and fetch the computed result (trends, distinct users, counts, breakdowns). | POST `/datafinder/openapi/v1/analysis` | `dsl:object` | [文档](https://www.volcengine.com/docs/84129/1285239?lang=zh) |
